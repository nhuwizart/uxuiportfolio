...
export const Home = () => {
    ...
    <section id="home" className="min-h-screen flex items-center justify-center relative">
        ...
        <div className="text-center z-10 px-4">
            <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-blue-500 to-cyan-400 bg-clip-text text-transparent leading-right">Hi, I'm Nhu Hoang</h1>
            <p className="text-gray-400 text-lg mb-8 max-w-lg mx-auto">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Suscipit asperiores nihil autem officia laudantium enim sint incidunt accusamus nulla modi.</p>
